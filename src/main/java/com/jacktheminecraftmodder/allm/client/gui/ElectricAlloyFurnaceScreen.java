...
public class ElectricAlloyFurnaceScreen extends ContainerScreen<ElectricAlloyFurnaceContainer> {

    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(Reference.MOD_ID, "textures/gui/electric_alloy_furnace.png");

    public ElectricAlloyFurnaceScreen(final ElectricAlloyFurnaceContainer container, final PlayerInventory inventory, final ITextComponent title) {
    ...
    public void render(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final ElectricAlloyFurnaceTile tileEntity = this.container.tileEntity;
    ...
    protected void drawGuiContainerBackgroundLayer(final float partialTicks, final int mouseX, final int mouseY) {
        ...
        final ElectricAlloyFurnaceTile tileEntity = container.tileEntity;
