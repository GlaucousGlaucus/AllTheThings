...
public class MysticFurnaceContainer extends Container {

    public final MysticFurnaceTile tileEntity;
     ...
     */
    public MysticFurnaceContainer(final int windowId, final PlayerInventory playerInventory, final PacketBuffer data) {
        this(windowId, playerInventory, getTileEntity(playerInventory, data));
    }

    public MysticFurnaceContainer(final int windowId, final PlayerInventory playerInventory, final MysticFurnaceTile tileEntity) {
        super(Register.MYSTIC_FURNACE_CONTAINER.get(), windowId);
        ...
        this.addSlot(new SlotItemHandler(tileEntity.inventory, MysticFurnaceTile.INPUT_SLOT, 50, 31));
        this.addSlot(new SlotItemHandler(tileEntity.inventory, MysticFurnaceTile.MODIFIER_SLOT, 110, 57));
        this.addSlot(new SlotItemHandler(tileEntity.inventory, MysticFurnaceTile.OUTPUT_SLOT, 110, 31));
    ...
    private static MysticFurnaceTile getTileEntity(final PlayerInventory playerInventory, final PacketBuffer data) {
        Objects.requireNonNull(playerInventory, "playerInventory cannot be null!");
        Objects.requireNonNull(data, "data cannot be null!");
        final TileEntity tileAtPos = playerInventory.player.world.getTileEntity(data.readBlockPos());
        if (tileAtPos instanceof MysticFurnaceTile)
            return (MysticFurnaceTile) tileAtPos;
    ...
    public boolean canInteractWith(@Nonnull final PlayerEntity player) {
        return isWithinUsableDistance(canInteractWithCallable, player, Register.MYSTIC_FURNACE.get());
    }
