...
public class ElectricAlloyFurnaceTile extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
    ...
    public final ItemStackHandler inventory = new ItemStackHandler(2) {
        ...
        protected void onContentsChanged(final int slot) {
            ...
            ElectricAlloyFurnaceTile.this.markDirty();
        }
    };
    ...
    public ElectricAlloyFurnaceTile() {
        super(Register.ELECTRIC_ALLOY_FURNACE_TILE.get());
    }
    ...
    public ITextComponent getDisplayName() {
        return new TranslationTextComponent(Register.ELECTRIC_ALLOY_FURNACE.get().getTranslationKey());
    }

    @Nonnull
    @Override
    public Container createMenu(final int windowId, final PlayerInventory inventory, final PlayerEntity player) {
        return new ElectricAlloyFurnaceContainer(windowId, inventory, this);
    }
